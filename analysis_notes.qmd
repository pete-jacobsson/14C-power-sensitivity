...
Now, I do not feel like running everything through OxCal again, so in the first instance I'll try using the relevant R packages (after checking for comprability with the ugly thing that is!).
