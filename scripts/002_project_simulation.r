##Set to single simulation to avoid accidental overwriting etc.
library(tidyverse)
source("001_simulation_tools.R")
oxcal_dir <- "C:/Users/your_username/your_oxcal_folder/"
...
seqs_031_params <- read_csv("seqs_031_params.csv")
...
seqs_032_params <- read_csv("seqs_031_params.csv")
...
seqs_033_params <- read_csv("seqs_033_params.csv")
